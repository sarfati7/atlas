...
**IMPORTANT:** Use `/frontend-design:frontend-design` skill when creating UI components to ensure high design quality and avoid generic AI aesthetics. The skill produces distinctive, production-grade interfaces.
</execution_context>
